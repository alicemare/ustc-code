...
#create_clock -add -name sys_clk_pin -period 10.00 -waveform {0 5} [get_ports {00MHZ}];
...
#et_property -dict { PACKAGE_PIN T10   IOSTANDARD LVCMOS33 } [get_ports { seg[0] }]; #IO_L24N_T3_A00_D16_14 Sch=ca
...
#et_property -dict { PACKAGE_PIN J17   IOSTANDARD LVCMOS33 } [get_ports { an[0] }]; #IO_L23P_T3_FOE_B_15 Sch=an[0]
...
set_property -dict { PACKAGE_PIN M18   IOSTANDARD LVCMOS33 } [get_ports { rst_n }]; #IO_L4N_T0_D05_14 Sch=btnu
