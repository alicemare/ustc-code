...
#
# Generated by Vivado on Fri Nov 23 16:54:30 CST 2018
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../8_2_1.srcs/sources_1/ip/clk_wiz_0" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../../8_2_1.srcs/sources_1/ip/clk_wiz_0" \
    "$ref_dir/../../../../8_2_1.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0_sim_netlist.v" \
  2>&1 | tee -a vlogan.log
...
create_lib_mappings()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="/home/alicemare/Documents/HDL/lab8/8_2_1/8_2_1.cache/compile_simlib/vcs"
  fi
